...
<body>
	...
	<div id="goods_image">
		<figure>
			<img alt="HTML5 &amp; CSS3" src="${contextPath}/thumbnails.do?
					goods_id=${goods.goods_id}&fileName=${goods.goods_fileName}">
		</figure>
	</div>
		...
		<table>
			<tbody>
				...
				<tr class="dot_line">
					...
					<td class="active">
						<span> 
							<fmt:formatNumber value="${goods.goods_price*0.9}" 
				...
				<tr class="dot_line">
					...
					<td class="fixed">
						만원이상 구매시 1,000P, 5만원이상 구매시 2,000P추가적립
						편의점 배송 이용시 300P 추가적립
					</td>
				</tr>
		...
		<div class="tab_container">
			<div class="tab_content" id="tab1">
				...
				<p>${fn:replace(goods.goods_intro, crcn, br)}</p>
					<!-- replace함수를 이용하여 저자 소개에 포함된 crcn(개행문자)을
						 br(<br>태그)로 대체함 -->
				<c:forEach var="image" items="${imageList }">
					<img src="${contextPath}/download.do?
							goods_id=${goods.goods_id}&fileName=${image.fileName}">
				</c:forEach>
			</div>
