...
<script>
	...
	// 빠른 메뉴의 다음클릭시 hidden태그에 저장된 상품 정보를 가져와 이미지를 표시함
	function fn_show_next_goods() {
		...
		// 다음 클릭 시 배열의 인덱스를 1증가시킴
		if (array_index < _h_goods_id.length - 1)
			array_index++;

		// 증가된 인덱스에 대한 배열 요소의 상품번호와 이미지 파일이름을 가져와 표시함
